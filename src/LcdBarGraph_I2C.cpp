...
// -- filled character
byte LcdBarGraph_I2C::_level0[8] = {
    B11111,
    B11111,
    B11111,
    B11111,
...
byte LcdBarGraph_I2C::_level1[8] = {
    B10000,
    B10000,
    B10000,
    B10000,
...
byte LcdBarGraph_I2C::_level2[8] = {
    B11000,
    B11000,
    B11000,
    B11000,
...
byte LcdBarGraph_I2C::_level3[8] = {
    B11100,
    B11100,
    B11100,
    B11100,
...
byte LcdBarGraph_I2C::_level4[8] = {
    B11110,
    B11110,
    B11110,
    B11110,
...
// -- constructor
LcdBarGraph_I2C::LcdBarGraph_I2C(LiquidCrystal_I2C* lcd, byte numCols, byte startX, byte startY)
{
    // -- setting fields
    _lcd = lcd;
    _numCols = numCols;
...
// -- the draw function
void LcdBarGraph_I2C::drawValue(int value, int maxValue) {
